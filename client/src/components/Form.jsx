...
const Form = ({ showFeedback }) => {
  ...
  return (
    <div className='container'>
      ...
      <ul className='msg-display' ref={messagesListRef} onScroll={() => setShowScrollButton(messagesListRef.current.scrollTop < messagesListRef.current.scrollHeight - messagesListRef.current.clientHeight - 1)}>
